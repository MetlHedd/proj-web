    ...
    <div className="bg-white w-full p-8">
      {
        tickets.map((ticket, index) => (
          <Ticket key={index} qrCode={`https://chart.googleapis.com/chart?cht=qr&chl=${ticket.ticket._id}&chs=240x240&choe=UTF-8&chld=L|2`} image={ticket.party.image} title={ticket.party.name} />
        ))
      }
    </div>
  </div>
